...
public class MeasurementsManagerTest extends RobolectricAbstractTest {
    ...
    public void testCanUpload() {
        ...
        List<Measurement> measurements =
                ResultFactory.createAndSave(OONITests.WEBSITES.toOONIDescriptor(c).getTest(c), 1, 0, false)
                        .getMeasurements();
    ...
    public void testUploadableReports() {
        // Arrange
        Result testResult = ResultFactory.createAndSave(OONITests.WEBSITES.toOONIDescriptor(c).getTest(c), 5, 0, false);
    ...
    public void testNoUploadableReports() {
        // Arrange
        ResultFactory.createAndSave(OONITests.WEBSITES.toOONIDescriptor(c).getTest(c));
    ...
    public void getReadableEntry() throws IOException {
        ...
        Measurement measurement =
                ResultFactory.createAndSaveWithEntryFiles(c, OONITests.WEBSITES.toOONIDescriptor(c).getTest(c), 1, 0, false)
    ...
    public void downloadReportFailTest() {
        // Arrange
        Measurement measurement = ResultFactory.createAndSave(OONITests.WEBSITES.toOONIDescriptor(c).getTest(c)).getMeasurements().get(0);
    ...
    public void reSubmitTest() {
        try {
            ...
            Measurement measurement = ResultFactory.createAndSaveWithEntryFiles(
                    c,
                    OONITests.WEBSITES.toOONIDescriptor(c).getTest(c),
                    5,
                    0,
                    false
            ).getMeasurements().get(0);
    ...
    private Measurement buildMeasurement() {
        return ResultFactory.createAndSave(OONITests.WEBSITES.toOONIDescriptor(c).getTest(c))
                .getMeasurements()
                .get(0);
    }
}
