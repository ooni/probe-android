...
public class MeasurementItem extends HeterogeneousRecyclerItem<Measurement, MeasurementItem.ViewHolder> {
	...
	@Override public void onBindViewHolder(ViewHolder viewHolder) {
		...
		if (extra.test_name.equals(WebConnectivity.NAME)) {
			...
			viewHolder.text.setCompoundDrawablesRelativeWithIntrinsicBounds(extra.url.getCategoryIcon(viewHolder.text.getContext()), 0, extra.is_anomaly ? R.drawable.exclamation_24dp : extra.is_failed ? R.drawable.error : R.drawable.tick_green_24dp, 0);
		} else {
			viewHolder.text.setText(test.getLabelResId());
			viewHolder.text.setCompoundDrawablesRelativeWithIntrinsicBounds(test.getIconResId(), 0, extra.is_anomaly ? R.drawable.exclamation_24dp : extra.is_failed ? R.drawable.error : R.drawable.tick_green_24dp, 0);
		}
