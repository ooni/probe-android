...
public class CircumventionItem extends HeterogeneousRecyclerItem<Result, CircumventionItem.ViewHolder> {
    ...
    @Override public ViewHolder onCreateViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        return new ViewHolder(ItemCircumventionBinding.inflate(layoutInflater, viewGroup, false));
    }
    ...
    @Override public void onBindViewHolder(ViewHolder viewHolder) {
        ...
        viewHolder.binding.failedMeasurements.setText(viewHolder.binding.failedMeasurements.getContext().getResources().getQuantityString(R.plurals.TestResults_Overview_Circumvention_Blocked, blocked.intValue(), blocked.toString()));
        viewHolder.binding.okMeasurements.setText(viewHolder.binding.failedMeasurements.getContext().getResources().getQuantityString(R.plurals.TestResults_Overview_Circumvention_Available, available.intValue(), available.toString()));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ItemCircumventionBinding binding;

        ViewHolder(ItemCircumventionBinding binding) {
