...
public class TestKeys {
    ...
    public String getMedianBitrate(Context ctx){
        ...
        if (this.median_bitrate != null){
            return setFractionalDigits(getScaledValue(this.median_bitrate));
        }
        return ctx.getString(R.string.TestResults_NotAvailable);
    }
    ...
    public String getMedianBitrateUnit(Context ctx){
        if (this.median_bitrate != null){
            return getUnit(this.median_bitrate, ctx);
        }
        return ctx.getString(R.string.TestResults_NotAvailable);
    }
    ...
    public String getVideoQuality(Context ctx, Boolean extended){
        if (this.median_bitrate != null){
            return minimumBitrateForVideo(this.median_bitrate, extended);
        }
        return ctx.getString(R.string.TestResults_NotAvailable);
    }
    ...
    public String getPlayoutDelay(Context ctx){
        if (this.min_playout_delay != null){
            return String.format(Locale.getDefault(),"%.2f", this.min_playout_delay);
        }
        return ctx.getString(R.string.TestResults_NotAvailable);
    }
}
