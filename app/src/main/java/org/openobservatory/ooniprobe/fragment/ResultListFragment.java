...
public class ResultListFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener, ConfirmDialogFragment.OnConfirmedListener {
	...
	@Override public boolean onLongClick(View v) {
		Result result = (Result) v.getTag();
		ConfirmDialogFragment.newInstance(result, null, getString(R.string.Modal_DoYouWantToDeleteThisTest), null, getString(R.string.Modal_Delete), null, null).show(getChildFragmentManager(), null);
		return true;
	}
