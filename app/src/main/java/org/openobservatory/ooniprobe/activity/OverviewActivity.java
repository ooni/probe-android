...
public class OverviewActivity extends AbstractActivity {
    ...
    public static void setRichText(TextView view, String richText, String testSuiteName) {
        try {
            Markwon markwon = Markwon.builder(view.getContext()).usePlugin(new ReadMorePlugin(
                    view.getContext().getString(R.string.OONIRun_ReadMore),
                    view.getContext().getString(R.string.OONIRun_ReadLess))
            ).build();
