...
public class WebsitesTest extends MeasurementAbstractTest {
    ...
    public void testHeaderData() {
        // Arrange
        Result testResult = ResultFactory.createAndSave(new WebsitesSuite(resources), 10, 2);
    ...
    public void checkListOfMeasurementsTest() {
        ...
        Result testResult = ResultFactory.createAndSave(new WebsitesSuite(resources), successfulMeasurements, failedMeasurement);
    ...
    public void testSucceed() {
        // Arrange
        Result testResult = ResultFactory.createAndSave(new WebsitesSuite(resources));
    ...
    public void testBlocked() {
        // Arrange
        Result testResult = ResultFactory.createAndSave(new WebsitesSuite(resources), 0, 3);
        Measurement measurement = testResult.getMeasurementsSorted().get(0);
        String headerOutcome = measurement.getUrlString() + "\n" + BLOCKED_OUTCOME;
